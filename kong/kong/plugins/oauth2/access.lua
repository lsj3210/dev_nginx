...
local function openapi_retrieve_parameters()
  local uri_args = kong.request.get_query()
  local method   = kong.request.get_method()
  ...
  uri_args["scope"] = "auth_token"
  uri_args["response_type"] = "token"
  uri_args["authenticated_userid"] = "authenticated_userid"
  uri_args["provision_key"] = route["id"]
...
local function authorize(conf)
  ...
  local parameters = openapi_retrieve_parameters()
